            ...
            <div class="bg-emerald-50 border border-emerald-200 rounded-xl p-6 mb-6">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-emerald-700 mb-4">Voici les identifiants de connexion pour l'étudiant:</p>
                        ...
                        <p class="text-xs text-emerald-600 mt-3">Important: Veuillez communiquer ces identifiants à l'étudiant de manière sécurisée.</p>
                    </div>
                </div>
            </div>
            @endif
                    ...
                    <table class="w-full">
                        <thead class="bg-slate-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-right text-xs font-semibold text-slate-500 uppercase tracking-wider">Mot de passe</th>
                        ...
                        <tbody class="divide-y divide-slate-100">
                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    @if($etudiant->utilisateur?->temporary_password)
                                        <div x-data="{ show: false }" class="flex items-center gap-2">
                                            <span x-text="show ? '{{ $etudiant->utilisateur->temporary_password }}' : '••••••'" class="font-mono text-slate-600"></span>
                            ...
                            @empty
                            <tr>
                                <td colspan="7" class="px-6 py-8 text-center text-slate-500">Aucun étudiant trouvé.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
